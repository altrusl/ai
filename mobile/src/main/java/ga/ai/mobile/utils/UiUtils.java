...
public class UiUtils {
    ...
    static public void updateHideReadButton(Context context, FloatingActionButton fab) {
        if (fab == null) {
            return;
        }

        if (PrefUtils.getBoolean(PrefUtils.SHOW_READ, true)) {
            fab.setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.fab_pink)));
            fab.setImageResource(R.drawable.ic_visibility);
        } else {
            fab.setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.fab_gray)));
